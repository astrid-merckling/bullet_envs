...
class MJCFBaseBulletEnv(gym.Env):
    ...
    def render(
        ...
        im_shapes = (
            [image_size, image_size, 3] if color else [image_size, image_size, 1]
        )
        ...
        proj_matrix = self._p.computeProjectionMatrixFOV(
            fov=60, aspect=float(VP_W) / VP_H, nearVal=0.1, farVal=100.0
        )
